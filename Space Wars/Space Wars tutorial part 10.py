...
class Player(Sprite):
    def __init__(self, spriteshape, color, startx, starty):
        ...
        self.shapesize(stretch_wid=0.7, stretch_len=1.1, outline=None)
        self.speed = 4
        self.lives = 3
...
class Particle(Sprite):
    def __init__(self, spriteshape, color, startx, starty):
        Sprite.__init__(self, spriteshape, color, startx, starty)
        self.shapesize(stretch_wid=0.15, stretch_len=0.15, outline=None)
        self.goto(-1000,-1000)
        self.frame = 0
